...
2. 能够说出jQuery入口函数的简单写法

3. 能够说出DOM对象 和 jQuery对象的区别

4. 能够说出常用的 3 ~ 4 中 jQuery基本选择器

5. 能够使用addClass 和 removeClass操作类样式
...
![image-20220522010231422](imgs/image-20220522010231422.png)

##### 2. 点击压缩版本下载

![image-20220522010324228](imgs/image-20220522010324228.png)

##### 3. 打开页面后，Ctrl + S 保存

- Ctrl + S 保存
- 全选 ctrl+All,  鼠标点击右键 复制粘贴。

##### 4. 这年代感悠然而生~~

- 查看 [github - jquery](https://github.com/jquery/jquery)
...
jquery文档- 线上：https://jquery.cuishifeng.cn/
